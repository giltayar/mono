...
CREATE TABLE
  IF NOT EXISTS sale_search (
    data_id UUID NOT NULL,
    searchable_text TEXT NOT NULL
  );

CREATE UNIQUE INDEX IF NOT EXISTS sale_search_idx ON sale_search (data_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS sale_product_idx ON sale_product (data_id, item_order);
...
CREATE UNIQUE INDEX IF NOT EXISTS sale_data_cardcom_idx ON sale_data_cardcom (data_id);
