...
test('create product and update multiple fields', async ({page}) => {
  ...
  await expect(newForm.sendSkoolInvitationCheckbox().locator).toBeHidden()
  ...
  // Verify the skool checkbox is hidden after create
  await expect(updateForm.sendSkoolInvitationCheckbox().locator).toBeHidden()
  ...
  // Verify the skool checkbox is hidden after update
  await expect(updateForm.sendSkoolInvitationCheckbox().locator).toBeHidden()
