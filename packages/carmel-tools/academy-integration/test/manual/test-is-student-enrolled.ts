...
console.log(
  await service.isStudentEnrolledInCourse('gil@tayar.org', 17031, {accountSubdomain: 'carmel'}),
)
console.log(
  await service.isStudentEnrolledInCourse('zmil@tayar.org', 17031, {accountSubdomain: 'carmel'}),
)
console.log(
  await service.isStudentEnrolledInCourse('zmil@tayar.org', 17031233333333, {
